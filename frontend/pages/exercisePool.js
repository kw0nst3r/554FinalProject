const exercisePool = [
  ...
  { name: 'Band Pull-Apart', muscles: ['shoulders','upper_back', 'rear_delts', 'shoulders',] },
  { name: 'Banded Face Pull', muscles: ['shoulders','upper_back','rear_delts', 'shoulders', 'traps'] },
  { name: 'Barbell Front Raise', muscles: ['shoulders','front_delts'] },
  { name: 'Barbell Rear Delt Row', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Barbell Upright Row', muscles: ['shoulders', 'traps'] },
  { name: 'Behind the Neck Press', muscles: ['shoulders','front_delts', 'triceps'] },
  { name: 'Cable Front Raise', muscles: ['shoulders','front_delts'] },
  { name: 'Cable Lateral Raise', muscles: ['shoulders', 'side_delts'] },
  { name: 'Cable Rear Delt Row', muscles: ['shoulders','rear_delts'] },
...
{ name: 'Back Extension', muscles: ['back', 'lower_back', 'glutes'] },
...
{ name: 'Floor Back Extension', muscles: ['back','lower_back', 'glutes'] },
