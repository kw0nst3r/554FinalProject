const exercisePool = [
    // Chest
  { name: 'Assisted Dip', muscles: ['chest', 'shoulders', 'front_delts', 'triceps'] },
  { name: 'Band-Assisted Bench Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  { name: 'Bar Dip', muscles: ['chest', 'shoulders', 'triceps', 'front_delts'] },
  { name: 'Bench Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  { name: 'Bench Press Against Band', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  ...
  { name: 'Incline Bench Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  { name: 'Incline Dumbbell Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  ...
  { name: 'Push-Up', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  { name: 'Push-Up Against Wall', muscles: ['chest', 'triceps'] },
  { name: 'Push-Ups With Feet in Rings', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  ...
  { name: 'Smith Machine Incline Bench Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  ...
  // Shoulders
  { name: 'Arnold Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Band Pull-Apart', muscles: ['rear_delts', 'shoulders', 'upper_back'] },
  { name: 'Banded Face Pull', muscles: ['rear_delts', 'shoulders', 'traps'] },
  { name: 'Barbell Front Raise', muscles: ['front_delts', 'shoulders'] },
  { name: 'Barbell Rear Delt Row', muscles: ['back', 'rear_delts', 'shoulders'] },
  { name: 'Barbell Upright Row', muscles: ['shoulders', 'traps'] },
  { name: 'Behind the Neck Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Cable Front Raise', muscles: ['front_delts', 'shoulders'] },
  { name: 'Cable Lateral Raise', muscles: ['shoulders', 'side_delts'] },
  { name: 'Cable Rear Delt Row', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Devils Press', muscles: ['chest', 'front_delts', 'shoulders', 'triceps'] },
  { name: 'Dumbbell Front Raise', muscles: ['front_delts', 'shoulders'] },
  { name: 'Dumbbell Lateral Raise', muscles: ['shoulders', 'side_delts'] },
  { name: 'Dumbbell Rear Delt Row', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Dumbbell Shoulder Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Face Pull', muscles: ['rear_delts', 'shoulders', 'traps'] },
  { name: 'Front Hold', muscles: ['front_delts', 'shoulders'] },
  { name: 'Landmine Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Machine Lateral Raise', muscles: ['shoulders', 'side_delts'] },
  { name: 'Machine Shoulder Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Monkey Row', muscles: ['shoulders', 'traps'] },
  { name: 'One-Arm Landmine Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Overhead Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Plate Front Raise', muscles: ['front_delts', 'shoulders'] },
  { name: 'Push Press', muscles: ['front_delts', 'quads', 'shoulders', 'triceps'] },
  { name: 'Reverse Cable Flyes', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Reverse Dumbbell Flyes', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Reverse Machine Fly', muscles: ['rear_delts', 'shoulders'] },
  { name: 'Seated Dumbbell Shoulder Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Seated Barbell Overhead Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Seated Smith Machine Shoulder Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Snatch Grip Behind the Neck Press', muscles: ['front_delts', 'shoulders', 'triceps'] },
  { name: 'Squat Jerk', muscles: ['hamstrings', 'quads', 'shoulders', 'triceps'] },
  { name: 'Split Jerk', muscles: ['hamstrings', 'quads', 'shoulders', 'front_delts', 'triceps'] },
